<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?php if($_SERVER['REQUEST_URI'] == "/HONLIZ.COM/data.php")
                echo "active ";?>treeview">
                <a href="data.php">
                    <i class="fa fa-user"></i> <span>Customer</span> <i class=""></i>
                </a>
            </li>
            <li class="<?php if($_SERVER['REQUEST_URI'] == "/HONLIZ.COM/orders.php")
                echo "active ";?>treeview">
                <a href="orders.php">
            ...
            <li class="<?php if($_SERVER['REQUEST_URI'] == "/HONLIZ.COM/addArticle.php")
                echo "active ";?>treeview">
                <a href="addArticle.php">
                    <i class="fa fa-plus"></i> <span>Add New Article</span> <i class=""></i>
                </a>
            </li>
            <li class="<?php if($_SERVER['REQUEST_URI'] == "/HONLIZ.COM/articles.php")
                echo "active ";?>treeview">
                <a href="articles.php">
            ...
            <li class="<?php if($_SERVER['REQUEST_URI'] == "/HONLIZ.COM/addBrand.php")
                            echo "active ";?> treeview">
                <a href="addBrand.php">
            ...
            <li class="<?php if($_SERVER['REQUEST_URI'] == "/HONLIZ.COM/addCategory.php")
                echo "active ";?>treeview">
                <a href="addCategory.php">
                    <i class="fa fa-plus"></i> <span>Add Category Name</span> <i class=""></i>
                </a>
            </li>
            <li class="<?php if($_SERVER['REQUEST_URI'] == "/HONLIZ.COM/phpMail.php")
                echo "active ";?>treeview">
                <a href="phpMail.php">
                    <i class="fa fa-mail-forward"></i> <span>Send Newsletter</span> <i class=""></i>
                </a>
            </li>
            <li class="<?php if($_SERVER['REQUEST_URI'] == "/HONLIZ.COM/addPoster.php")
                echo "active ";?>treeview">
