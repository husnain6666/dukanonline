...
<head>
    ...
    <script>
        function userAction(user, action) {
            ...
            xmlhttp.open("GET", "bestSellerInactive.php?q=" + user + "&a=" + action, true);
            xmlhttp.send();
        }
    </script>
    <meta charset="UTF-8">
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Best Seller
                <small>showing all Best Seller</small>
            </h1>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h1 class="box-title">Best Seller Details</h1>
                        </div>
                        <!-- /.box-header -->
...
<script type="text/javascript">
    ...
    $('#resetModal').on('show.bs.modal', function (e) {
        var userId = $(e.relatedTarget).data('user-name');
        userName = $(e.relatedTarget).data('user-id');
        $(e.currentTarget).find('p[name="user-reset"]').html('Do you want to de-activate hot deal <strong>' + userId + '</strong>?');
    });
</script>
<script>
    var id1;
