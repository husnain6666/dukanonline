        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    ...
                    $addId = $_GET['Id'];
                    if(isset($addId)){
                        $query = "SELECT * FROM slider where sliderId= $addId";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            <div class="box box-info" id="form" >
                                <div class="box-header with-border">
                                    <h3 class="box-title">Update your slider here</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
                                <form action="sliderUpdate.php" class="form-horizontal"  method="Post" enctype=multipart/form-data>
                                    <div class=" box-body" >
                        ...
                        <?php
                            ...
                            <div class="box box-info" style="text-align: center" >
                                <div class="box-header with-border">
                                    <h3 class="box-title">Update your Clients here</h3>
                                </div><!-- /.box-header -->
                                <label style="color:red;"><strong>No such Client present</strong></label>
                            </div>
                        <?PHP
                        }
