...
if(isset($_POST['submit1'])) {
    ...
    if(empty($errors)){
        ...
        if($result) {
            $sql = "INSERT INTO `subbcategory`(subCategory,categoryName) VALUES('$mastercat','$article_name')";
            $result = mysqli_query($CONNECTION, $sql);
        }
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box box-info" id="form" >
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Add Sub-Sub Category Form</h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody id="userData">
                        <?php
                        $query = "SELECT * FROM category where categoryName IN (select categoryName from subbcategory where subCategory='$mastercat')";
...
<script type="text/javascript">
    ...
    function newtab(id){
        ...
        url='updatesubsub.php?q='+userid+'&m=<?php echo $mastercat; ?>';
