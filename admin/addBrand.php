...
//    echo "<script type='text/javascript'>$('#submit1').click(function(event){event.preventDefault(); }); </script>";
    ...
    if(empty($errors)){
        ...
        include_once('dbConnect.php');
        $sql = "INSERT INTO `brand`(brandName,picture) VALUES('$article_name','$pic1')";
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Add Brand
                <small>Add New Brand Name</small>
            </h1>
                        ...
                        <form class="form-horizontal" id='insertform' enctype="multipart/form-data"  method="Post">
                            <div class=" box-body" >
                                ...
                                <div class=" form-group">
                                    <label for="qty" class="col-sm-2 control-label" align="left">Choos Brand Picture*</label>

                                    <div class="col-sm-offset-2">
                                        <input type="file" class="col-sm-8 control-label" name="pic1" id="pic1"  required/>
                                ...
                                if($result->num_rows > 0) {
                                    while ($member = mysqli_fetch_assoc($result)) {
                                        ...
                                        echo "<tr>".
                                            ...
                                            "<td> <img src='$path1$picture' width='100px' height='60px' border='1'  /> </td>".
                                            "<td align='center'>".
                                            "<button class='btn btn-success btn-xs' data-toggle='modal' data-target='' title='' onclick='newtab(this)'  data-original-title='{$member['brandName']}' data-user-id={$member['brandName']}><i class='fa fa-refresh'></i></button>&nbsp;".
