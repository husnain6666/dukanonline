...
$q=$_GET['q'];
$query ="SELECT  * from brand WHERE   brandName='$q'";
...
if(isset($_POST['submit1']))
{
            ...
            if($size<(345*777))
            {
                ...
                if(move_uploaded_file($tmp, $path.$actual_image_name))
                {
                    if(file_exists ( $path.$actual_image_name )){
                        ...
                        if(empty($errors)){
                            include_once('dbConnect.php');
                            $sql = "update  `brand` SET brandName='$article_name',picture='$pic1' where brandName='$q'";
    ...
    if(empty($errors)){
        include_once('dbConnect.php');
        $sql = "update  `brand` SET brandName='$article_name' where brandName='$q'";
        $result = mysqli_query($CONNECTION, $sql);
        echo "<script>alert('Action Successfull');</script>";
        echo "<script> window.open ('addBrand.php','_self',false);</script>";
                        ...
                        <div class=" box-body" >
                            ...
                            <div class=" form-group">
                                <div class="col-sm-offset-3">
                                    <img src='<?php echo '$path1.$picture'; ?>'width="20%" height="20%" border="1" />
