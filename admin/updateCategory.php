...
if($name!="") {
        ...
        if (in_array($ext, $valid_formats)) {
            if ($size < (345 * 777)) {
                ...
                if (move_uploaded_file($tmp, $path1 . $actual_image_name)) {
                    ...
                    if (empty($errors)) {
                        include_once('dbConnect.php');
                        $sql = "update  `mastercategory` SET masterCategory='$article_name',pic='$pic1',description='$description',status='$afterStatus',piclogo='$iconN' where masterCategory='$q'";
    ...
    if (empty($errors)) {
        include_once('dbConnect.php');
        $sql = "update  `mastercategory` SET masterCategory='$article_name',description='$description',status='$afterStatus',piclogo='$iconN' where masterCategory='$q'";
        $result = mysqli_query($CONNECTION, $sql);
        echo'<style type="text/css">
                #idalert {
                    visibility: visible;
                                        ...
                                        <div>
                                            ...
                                            <div class="">
                                                <div class="col-md-3 col-md-offset-1">
                                                    <label id="iconName" name="iconName"><?php echo $picLogo; ?></label>
                                                    <input type="hidden" name="iconN" id="iconN" value="<?php echo $picLogo; ?>">
                                                </div>
                                                <div class="col-md-3 col-md-offset-2">
                                                    <i class="<?php echo $picLogo." fa-3x"; ?>" id="mainPic"></i>
                                                </div>
                                                <br/>
