...
if(isset($_POST['submit1'])) {
    ...
    if(empty($errors)){
        include_once('dbConnect.php');
        $sql = "INSERT INTO `subcategory`(subCategory,pic,description) VALUES('$article_name','$pic1','$description')";
        $result = mysqli_query($CONNECTION, $sql);

        if($result) {
            $sql = "INSERT INTO `masterrsub`(masterCategory,subCategory) VALUES('$mastercat','$article_name')";
            $result = mysqli_query($CONNECTION, $sql);
        }
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <form action="addCategory.php">
                <button class="btn btn-info  pull-right" style="margin-top: -20px;background-color: #808080" >back</button>
            </form>
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box box-info" id="form" >
                        ...
                        <div class="box-header with-border">
                            <h3 class="box-title">Add New Sub Category Form</h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" id='insertform' enctype="multipart/form-data"  method="Post">
                            <div class=" box-body" >
                                ...
                                <div class=" col-md-offset-1 form-group" >
                                    <label for="name"    class="col-sm-2 control-label" >Master Category</label>
                                    <p class="help-block text-danger"></p>


                                    <div class="col-sm-9">
                                        <input type="text"   class="form-control" id="article_name1" name="article_name" value='<?php echo $mastercat;?>' placeholder="" required >
                ...
                <div class="box-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody id="userData">
                        <?php
                        $query = "SELECT * FROM subcategory where subCategory IN (select subCategory from masterrsub where masterCategory='$mastercat')";
                            ...
                            if($result->num_rows > 0) {
                                while ($member = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<tr>".
                                        ...
                                        "<td align='right'>".
                                        "<button class='btn btn-success btn-xs' data-toggle='modal' data-target='' title='' onclick='newtab(this)'  data-original-title='{$member['subCategory']}' data-user-id={$member['subCategory']}><i class='fa fa-refresh'></i></button>&nbsp;".
                                        "<button class='btn btn-success btn-xs' data-toggle='modal' data-target='' title='' onclick='newcat(this)'  data-original-title='{$member['subCategory']}' data-user-id={$member['subCategory']}><i class='fa fa-plus'></i></button>&nbsp;".
                                        "</td>".
                                        "<td> $stat </td>".
                                        "</tr>";
                                }
...
<script type="text/javascript">
    ...
    function newtab(id){
        ...
        url='updatesubcat.php?q='+userid+'&m=<?php echo $mastercat; ?>';
