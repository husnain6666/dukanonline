  ...
  <body class="skin-blue sidebar-mini">
            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                <div class="box-header">
                  <h1 class="box-title">Users Details</h1>
                </div><!-- /.box-header -->
    ...
    <script type="text/javascript">
      ...
      $('#resetModal').on('show.bs.modal', function(e) {
          var userId = $(e.relatedTarget).data('user-name');
          userName = $(e.relatedTarget).data('user-id');
          $(e.currentTarget).find('p[name="user-reset"]').html('You want to set default password <i>"Electroshop@123"</i> for <strong>'+userId+'</strong>?');
      });
    </script>
    <script>
        var id1;
