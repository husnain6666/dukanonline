...
<head>
    ...
    <meta charset="UTF-8">
    <title>Add/Update Clients</title>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-info" id="form" >
                        <div class="box-header with-border">
                            <h3 class="box-title">Add your Clients here</h3>
                        </div><!-- /.box-header -->
                        <!-- form start -->
                        <form action="insertClient.php" class="form-horizontal"  method="Post" enctype=multipart/form-data>
                            <div class=" box-body" >
                    ...
                    <div class="box box-info" id="form" >
                        <div class="box-header with-border">
                            <h3 class="box-title">View/Update your Clients here</h3>
                        </div><!-- /.box-header -->
