...
<!--[if (gt IE 9)|!(IE)]><!-->
<html class="noIE" lang="en-US" xmlns="http://www.w3.org/1999/html">
<!--<![endif]-->
...
<header>
    <!-- Top Heading Bar -->
    <?php include_once("top_header.php")?>    <!-- end: Top Heading Bar -->

    <div class="f-space20"></div>
    <!-- Logo and Search -->
    <?php include_once("main_header.php")?>    <!-- end: Top Heading Bar -->
    ...
    <div class="container">
        <div class="row clearfix">
            ...
            <?php include_once("main_bar.php")?>    <!-- end: Top Heading Bar -->
        </div>
    </div>
</header>
<!-- end: Header -->
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="breadcrumb"> <a href="index.php"> <i class="fa fa-home fa-fw"></i> Home </a> <i class="fa fa-angle-right fa-fw"></i> <a href="DeliveryInformation.php"> Delivery Information </a> </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="page-content" style="margin-left: 50px">
                    <p>
                        <strong>   Cash On Delivery (Process Guide & Regulations):
                        </strong> </p>
                    <ul style="list-style-type:disc">
                        <li>Once you call us and select your product, we confirm your order before dispatching.</li>
                        <li>We put your order to our priority, and dispatch it with-in 24 hours (before 6 PM)</li>
                        <li>In Lahore, you get the delivery with-in 48 hours, in other cities it may depend on the size and weight and the targeted city.</li>
                        <li>For orders out of Lahore city premises, we take 100% advance payment via Easy Paisa, Western Union,  bank transfer and cash in hand. (Receipt Issued Accordingly)</li>
                        <li>We do not ship products out of country in any case</li>
                        <li>Complete price of product is to be paid on arrival of product at your door step</li>
                        <li>Once the cash has been paid and counted by our representative, only then, the product will be handed over.</li>
                        <li>UNFORTUNATELY, we do not have a credit policy in what so ever case.</li>
...
<!-- footer -->
<?php include_once("footer.php")?>    <!-- end: Top Heading Bar -->
<!-- end: footer -->
<!-- Style Switcher JS -->
