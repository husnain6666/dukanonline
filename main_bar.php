...
<!--#################################Adding dynamic categories############################################-->
                    ...
                    $query1 = "SELECT * FROM mastercategory WHERE status = '1' LIMIT 7";
                        ...
                        <div class="dropdown-menu flyout-menu">
                            ...
                            <ul>
                                        ...
                                        if($result5)
                                        {
                                            while($row5 = mysqli_fetch_assoc($result5))
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        if($totalSubSubCategory > 21) {
                                                            echo "<li><a href='category-grid.php?subsubCategory=$subCategory'>View More</a></li>";
                                                        }
                                                    ?>
                                                                  </ul>
                                                                </div>
                                ...
                                <?php
                                    ...
                                    if($totalSubCategory >7)
                                {
                                ?>
                                    <li><a href="category-grid.php?category=<?= $masterCategory ?>"><span>View More</span></a> <?php
                                }
                                } ?>
                            </ul>
                            <!-- end: Sub Menu -->
                    ...
                    <?php
                        ...
                        if($totalMasterCategory >7)
                        {
                        ?><li><a href="category-grid.php?category=all"> <i class="fa fa-files-o"></i> <span>View More</span></a></li><?php
                        }
                    } //end of if condition
                    ?>
                    <!-- end: Menu Item -->
