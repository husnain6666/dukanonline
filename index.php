                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item active">
                            <div class="row box-product">
                                <?php
                                $sql = "SELECT articleId,price,articleName,picture1,discount, pictureTag FROM article where weekDeal='1' limit 16";
                                ...
                                if ($slideCount == 4 || $slideCount == 7 || $slideCount == 10) {
...
<div class="container" style="padding: 0px">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 main-column box-block">
            <div class="box-heading"><span>SALE</span> <a class="fa fa-plus fa-lg" href="category-grid.php?s=1" data-toggle="tooltip" data-original-title='View More' id="view"></a></div>
            <div class="box-content">
                <div class="box-products slide" id="productc2">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item active">
                            <div class="row box-product">
                                <?php
                                $sql = "SELECT articleId,price,articleName,picture1,discount,pictureTag FROM article where Sale='1' limit 12";
                                $result=mysqli_query($connection,$sql);
                                $slideCount = 0;
                                while(($table_record=mysqli_fetch_array($result))) {
                                $articleName = $table_record['articleName'];
                                ...
                                if ($slideCount == 5 || $slideCount == 9 || $slideCount == 13) {
...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 main-column box-block">
            <div class="box-heading"><span>Recent Products</span> <a class="fa fa-plus fa-lg" href="category-grid.php?r=1" data-toggle="tooltip" data-original-title='View More' id="view"></a></div>
            <div class="box-content">
                <div class="box-products slide" id="">
                    <div class="carousel-inner">
                        <!-- Items Row -->
                        <div class="item active">
                            <div class="row box-product">
                                <?php
                                $sql = "SELECT articleId,price,articleName,picture1,discount,pictureTag FROM article group by articleId desc limit 12";
                                $result=mysqli_query($connection,$sql);
                                $slideCount = 0;
                                while(($table_record=mysqli_fetch_array($result))) {
                                $articleName = $table_record['articleName'];
