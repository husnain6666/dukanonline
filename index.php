                                    ...
                                    if ($slideCount%4 !== 0 ) {
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="product-block">
                                                <div class="image">
                                                    <div id="register">
                                             <!--     <button  class="product-label product-sale" id="mymodal"  type="button"  data-toggle="modal" data-target="#myModal" > Quick View</button>
                                                 -->   <a data-toggle="modal" data-id="ISBN564541" title="Add this item" class="open-AddBookDialog btn btn-primary" href="#addBookDialog">test</a>  <a class="img"
                                                            > <img
                                                            alt="product info"
...
<div class="row">
                                ...
                                $sql = "SELECT specification,category,price,articleName, brand, articleId, quantity, discount, picture1, picture2, picture3,color FROM article WHERE articleId='62'";
                                $result = mysqli_query($connection, $sql);
                                ...
                                try {
                                    ...
                                    $query2="SELECT count(articleId) as totalReviews FROM reviews WHERE articleId = '62'";
                                    $result2=mysqli_query($connection,$query2);

                                    $table_record2=mysqli_fetch_array($result2);
                                    $totalReviews = $table_record2['totalReviews'];

                                    $query3 = "select (select count(rating) from ratings where articleId = '62') as totalRating, SUM(rating) as sumRating from ratings where articleId = '62'";
...
<div class="row">
    <div class="col-md-6 col-md-lg=6 "></div>
...
<!-- add buttns from here-->


        </div>
</div> <!--End row of 2nd Half, all will be shown here -->
...
/*
    $.ajax({
        type : 'post',
        url : 'product.php', // in here you should put your query
        data :  'post_id='+ essay_id, // here you pass your id via ajax .
        // in php you should use $_POST['post_id'] to get this value
        success : function(r)
        {
            // now you can show output in your modal
            $('#addBookDialog').show();  // put your modal id
