...
function validation(){
    ...
    if(checkPassword===true)
        if (password === "") {
            ...
            checkContact=false;
            document.getElementById("passwordValid").innerHTML = "at least 4 characters and must contain uppercase,lowercase and a digit";
        }
...
function passwordValidation(){
    ...
    if (password === "") {
        ...
        document.getElementById("passwordValid").innerHTML = "Must contain uppercase,lowercase and a digit";
    }
...
//    var email=document.getElementById("emailAddress").value;
    ...
    var finalcheckbox=document.getElementById("termscheckbox");
...
*/
    ...
    if( checkbox===true && check_paymentMethod===true  && shipmentcheck===true   &&  check_city_ship===true &&   check_name_ship===true && checkContactship===true && check_country_country===true && check_address===true &&  check_email===true)
    {
