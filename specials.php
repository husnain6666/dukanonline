                    ...
                    <div class="item <?php if($count == 1){echo "active";}?>">
                        <div class="product-block">
                            <div class="image">
                                ...
                                <a class="img" href="product.php?articleId=<?php echo $articleId;?>"><img style="height: 17em;width: 100%" alt="product info" src="images/products/<?php echo $picture1?>" title="product title"></a> </div>
