...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="breadcrumb"> <a href="index.php"> <i class="fa fa-home fa-fw"></i> Home </a> <i class="fa fa-angle-right fa-fw"></i> <a href="shippingpartners.php"> SHIPPING PARTNERS </a> </div>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="page-content" style="margin-left: 50px">
                    <img src="images/shippingpartner/tcs.jpg" style="height: 200px;width: 250px" >
                    <img src="images/shippingpartner/blue.jpg" style="height: 200px;width: 250px" >
                    <img src="images/shippingpartner/leopards.jpg" style="height: 200px;width: 250px" >
                    <img src="images/shippingpartner/12y.jpg" style="height: 200px;width: 250px" >
                    <img src="images/shippingpartner/nccs.jpg" style="height: 200px;width: 250px" >
                    <img src="images/shippingpartner/new khan.jpg" style="height: 200px;width: 250px" >
                    <img src="images/shippingpartner/care cargo.jpg" style="height: 200px;width: 250px" >
                    <p><strong>For Details: +92 322 4859990</strong></p>
            </div>
        </div>
    </div>
