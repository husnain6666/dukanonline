...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="breadcrumb"> <a href="index.php"> <i class="fa fa-home fa-fw"></i> Home </a> <i class="fa fa-angle-right fa-fw"></i> <a href="accountinfo.php"> Account Information </a> </div>
...
<div class="container">
        <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
                   <img style="height: 300px;width: 700px" src="images/bank/hbl-logo-new.jpg" >
                </div>
            <div class="col-lg-12 col-md-12 col-sm-12">
                <h2><strong>  Bank Transfer Instructions </strong> </h2>
                <br/>
                <p>Please transfer the total amount to the following bank account.</p>
                <strong> Account Number:</strong>  0001957901347703

                <br/>
                <strong> Account Title :</strong> Ahmed Bin Tariq

                <br/>
                <strong>  HBL </strong>

                <br/>
                <strong> Branch: </strong>Shadman Lahore <strong>Branch Code:</strong>128

                <br/>
                <strong>  For Details Call:</strong> +92 322 4859990

                <br/>
                <Strong>Note:</Strong>    Your order will not ship until we receive payment.            </div>
            <div class="col-lg-12 col-md-12 col-sm-12">
                <img style="height: 200px;width: 700px" src="images/bank/images.jpg" >
            </div>
            <div class="col-lg-12 col-md-12 col-sm-12">

            <Strong>EasyPaisa:</Strong>  We receive your order payments via Easy Paisa<br>
                <Strong>paypal:</Strong>For oversees Customers,  We received your order payments via Paypal. To get more details about paypal transfer, give us a call
