...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="breadcrumb"> <a href="index.php"> <i class="fa fa-home fa-fw"></i> Home </a> <i class="fa fa-angle-right fa-fw"></i> <a href="warrantyClaims.php"> PRIVACY POLICY </a> </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="page-content" style="margin-left: 50px">
                <ul style="list-style-type:disc">
                    ...
                    <li>You’re personal Information is in “SAFE HANDS”. </li>
                    <li>We never disclose your personal details with our vendors and our website
                        advertisers or whatsoever the third party is. </li>
                    <li>We personally guard it, it’s secured …!!!</li>
                    <li>Being confident, we would like you to be just sure to sign off your account
